...
##  Tech Stack
- **Backend:** Java 17, Spring Boot 4.1.0, Spring Data JPA, Spring Security with JWT (JSON Web Token) authentication
...
- **Testing:** JUnit 5, Mockito (Business logic test coverage >74%)
...
5. **Quality Assurance:** Covered core execution branches with high-quality Unit tests using Mockito stubs, yielding over 74% method and line coverage metrics.
6. **OpenAPI Specification:** `openapi.yaml` in project root
